...
from queries.accounts import Error, AccountIn, AccountRepository, AccountOut, Error, DuplicateAccountError
...
async def create_account(
    ...
    form = AccountForm(username=info.username, password=original_password)
