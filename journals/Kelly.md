...
## TEAM
- Jaime presented:
    - Yesterday we worked on unit tests and frontend views
    - Today we have one last unit test to complete and we will be wrapped up our frontend views
    -   No blockers at this time
## SOLO
- Work with team on visuals and coder homepage view
### 9/06/23
## TEAM
- Silvano presented:
...
#### DAILY JOURNAL
### 9/7/23
- Miguel completed his unit test
- Worked with team on visuals
- Worked with team in problem-solving Silvano's "game" code
- Silvano completed his frontend game view and sent a merge request which Jaime approved
- All team members pulled Silvano's changes
### 9/6/23
...
- I went through the lint test and pipelines and made modifications to the file in order to pass the lint test and pushed changes again
- Jaime approved my merge request and I merged to main and team pulled changes down locally
### 9/5/23
- work on unit test
### 9/2/23
